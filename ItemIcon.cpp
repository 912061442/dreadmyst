...
sf::Color ItemIcon::itemColor(const ItemDefines::Quality quality)
{
	switch (quality)
	{
		case ItemDefines::Quality::QualityLv0:	return sf::Color(0x8e8b92ff);
		case ItemDefines::Quality::QualityLv1:	return sf::Color(0xf2f1f1ff);
		case ItemDefines::Quality::QualityLv2:	return sf::Color(0x1ef002ff);
		case ItemDefines::Quality::QualityLv3:	return sf::Color(0x3e9dffff);
		case ItemDefines::Quality::QualityLv4:	return sf::Color(0xff73b3ff);
		case ItemDefines::Quality::QualityLv5:	return sf::Color(0xb33ffaff);
	}
...
void ItemIcon::fillTooltip() /*final*/
{
		...
		if (auto world = getWorld())
		{
			if (auto myself = world->myself())
			{
				...
				else
				{
					...
					{
						// Can use this, but don't meet stat requirement
						m_hasEquipErrors = true;
	...
	if (!failedStatReq.empty())
	{
		// Also note for them which requirements they have met
